...
export function RowHunt({
  ...
  function check() {
    ...
    if (correct) {
      ...
      // Wrong: let them look and try again — the table itself is the teacher.
  ...
  const showTable = phase === "round" || phase === "feedback";

  return (
    <div className="rounded-2xl border border-violet-300/80 bg-linear-to-br from-violet-50/95 to-fuchsia-50/60 dark:border-violet-800/80 dark:from-violet-950/40 dark:to-fuchsia-950/20 p-5">
          ...
          {phase === "round" && (
            <div className="mt-3 flex flex-col items-center gap-2 text-center">
              ...
              <p className="text-xs text-zinc-500">
                Click rows to select them, then run.
              </p>
            </div>
          )}

          {phase === "feedback" && (
            <div className="mt-3 rounded-xl border border-violet-200 dark:border-violet-900 bg-white/70 dark:bg-zinc-900/40 p-3">
