...
//
// Like every game, the lesson shows a door card and the quest runs in the
        ...
        <GameModalBody>
          ...
          {playing && mission && (
            <div>
              ...
              {phase === "cleared" && (
                <div className="mt-3 rounded-xl border border-amber-200 dark:border-amber-900 bg-amber-50/60 dark:bg-zinc-900/40 p-3">
